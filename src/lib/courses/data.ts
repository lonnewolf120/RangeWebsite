...
/**
 * Hardcoded course data — the source of truth for the site.
 * Field-by-field docs live in `types.ts`.
 *
 * Only the CEH v12 record reflects a real, confirmed program. Every
 * other record is a full placeholder in the same shape (schedules,
 * fees and instructors marked "to be declared/announced") so the
 * detail pages render completely and each record can be replaced
 * field-for-field with real content later.
 */

const FULL_DAY = "9:00 AM – 5:00 PM";
const VENUE =
  "Cyber Range and Advanced Computing & Cybersecurity Lab, Tower 3, MIST";

/** Registration fine print shared by every course run. */
...
/** Standard cohort delivery team (same structure across programs). */
const TRAINING_TEAM: TeamRole[] = [
  {
...
/** Standard CACR evaluation criteria used across certificate courses. */
const STANDARD_CERTIFICATE: CertificateInfo = {
...
/** Instructor lineups for TBD cohorts are announced with each batch. */
const INSTRUCTORS_TBA: Instructor[] = [
  {
...
/** Overview table shared by not-yet-scheduled courses. */
function tbdOverview(level: string, duration: string): OverviewRow[] {
  return [
...
export const COURSES: Course[] = [
  ...
  /* ---------------------------------------------------------------- */
  {
    id: "soc-analysis-threat-hunting",
    ...
    courseSchedule: [
      {
        ...
        time: FULL_DAY,
        coverage:
          "SOC Fundamentals: roles, tiers, workflows and SIEM architecture",
      },
      {
        week: "Week 1",
        day: "Day 2 (TBD)",
      ...
      },
      {
        ...
        time: FULL_DAY,
        coverage:
          "Practical Lab: defend the range against a live attack campaign end-to-end",
      },
      {
        week: "Week 4",
        day: "Day 8 (TBD)",
        time: FULL_DAY,
        coverage:
          "Final Assessment & Presentation: internal certification evaluation",
      },
    ],
    scheduleNotes: [
  ...
  /* ---------------------------------------------------------------- */
  {
    id: "infosec-assessment-penetration-testing",
    ...
    courseSchedule: [
      {
        ...
        time: FULL_DAY,
        coverage:
          "Assessment Methodology: scoping, rules of engagement, reconnaissance & OSINT",
      },
      {
        week: "Week 2",
        day: "Friday (TBD)",
      ...
      },
      {
        ...
        time: FULL_DAY,
        coverage:
          "Exploitation: system and network exploitation, privilege escalation",
      },
      {
        week: "Week 4",
        day: "Friday (TBD)",
      ...
      },
      {
        ...
        time: FULL_DAY,
        coverage:
          "Reporting & Final Assessment: findings, risk rating, report writing and evaluation",
      },
    ],
    scheduleNotes: [
  ...
  {
    id: "ethical-hacking-countermeasures-vapt",
    ...
    courseSchedule: [
      ...
      },
      {
        ...
        time: FULL_DAY,
        coverage:
          "Malware Threats, Sniffing & Social Engineering — and countermeasures",
      },
      {
        week: "Week 3",
        day: "Day 5 (TBD)",
        time: FULL_DAY,
        coverage:
          "Web Server & Web Application Attacks, SQL Injection — and countermeasures",
      },
      {
        week: "Week 3",
        day: "Day 6 (TBD)",
        time: FULL_DAY,
        coverage:
          "Wireless, Mobile & Cloud Attacks — and countermeasures",
      },
      {
        week: "Week 4",
        day: "Day 7 (TBD)",
        time: FULL_DAY,
        coverage:
          "Full VAPT Engagement: assessment, exploitation and reporting on the range",
      },
      {
        week: "Week 4",
        day: "Day 8 (TBD)",
  ...
  {
    id: "digital-forensic-investigation",
    ...
    courseSchedule: [
      {
        ...
        time: FULL_DAY,
        coverage:
          "Forensic Fundamentals: process, legal considerations, chain of custody",
      },
      {
        week: "Week 2",
        day: "Day 2 (TBD)",
        time: FULL_DAY,
        coverage:
          "Evidence Acquisition: disk imaging, write blocking, integrity verification",
      },
      {
        week: "Week 3",
        day: "Day 3 (TBD)",
        time: FULL_DAY,
        coverage:
          "Disk & File-System Analysis: artifacts, timelines, deleted data recovery",
      },
      {
        week: "Week 4",
        day: "Day 4 (TBD)",
        time: FULL_DAY,
        coverage:
          "Memory & Network Forensics: volatile evidence, packet and log analysis",
      },
      {
        week: "Week 5",
        day: "Day 5 (TBD)",
        time: FULL_DAY,
        coverage:
          "Case Study & Final Assessment: full investigation, reporting and evaluation",
      },
    ],
    scheduleNotes: [
      "Tentative module plan — dates will be finalized when the cohort is announced.",
  ...
  {
    id: "information-systems-security-architecture",
    ...
    courseSchedule: [
      {
        ...
        time: FULL_DAY,
        coverage:
          "Security Architecture Principles: security models, frameworks, threat modeling",
      },
      {
        week: "Week 1",
        day: "Day 2 (TBD)",
        time: FULL_DAY,
        coverage:
          "Enterprise Architecture: layering, zoning, defense in depth, segmentation",
      },
      {
        week: "Week 2",
        day: "Day 3 (TBD)",
        time: FULL_DAY,
        coverage:
          "Network Security Design: perimeter, internal segmentation, monitoring points",
      },
      {
        week: "Week 2",
        day: "Day 4 (TBD)",
        time: FULL_DAY,
        coverage:
          "Identity & Access Architecture: IAM, federation, privileged access management",
      },
      {
        week: "Week 3",
        day: "Day 5 (TBD)",
        time: FULL_DAY,
        coverage:
          "Cryptographic Design: PKI, TLS, key management and data protection",
      },
      {
        week: "Week 3",
        day: "Day 6 (TBD)",
      ...
      },
      {
        ...
        time: FULL_DAY,
        coverage:
          "Capstone Design Review & Final Assessment: present and defend an architecture",
      },
    ],
    scheduleNotes: [
      "Tentative module plan — dates will be finalized when the cohort is announced.",
  ...
  {
    id: "application-software-cloud-security",
    ...
    courseSchedule: [
      {
        ...
        time: FULL_DAY,
        coverage:
          "Secure SDLC & OWASP Top 10: vulnerability classes and secure design",
      },
      {
        week: "Week 2",
        day: "Day 2 (TBD)",
        time: FULL_DAY,
        coverage:
          "Application Attack & Defense: exploiting and fixing web and API vulnerabilities",
      },
      {
        week: "Week 3",
        day: "Day 3 (TBD)",
      ...
      },
      {
        ...
        time: FULL_DAY,
        coverage:
          "Containers & DevSecOps: container hardening, orchestration security, CI/CD",
      },
      {
        week: "Week 5",
        day: "Day 5 (TBD)",
        time: FULL_DAY,
        coverage:
          "Practical Lab & Final Assessment: end-to-end secure deployment and evaluation",
      },
    ],
    scheduleNotes: [
      "Tentative module plan — dates will be finalized when the cohort is announced.",
  ...
  {
    id: "information-systems-auditing",
    ...
    courseSchedule: [
      {
        ...
        time: FULL_DAY,
        coverage:
          "IS Audit Fundamentals: standards, frameworks (COBIT, ISO 27001) and audit process",
      },
      {
        week: "Week 2",
        day: "Day 2 (TBD)",
      ...
      },
      {
        ...
        time: FULL_DAY,
        coverage:
          "Reporting & Final Assessment: audit report writing, case study and evaluation",
      },
    ],
    scheduleNotes: [
      "Tentative module plan — dates will be finalized when the cohort is announced.",
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    overview: [
      ...
      {
        label: "Duration",
        value: "12 Days (6 Weeks) every Friday & Saturday",
      },
      {
        label: "Complimentary Offer",
        value: "Additional Hours Cyber Range Access for hands-on practice",
    ...
    courseSchedule: [
      {
        ...
        time: "9 AM – 5 PM",
        coverage:
          "Module 1 & 2: Introduction to Ethical Hacking, Footprinting & Reconnaissance",
      },
      {
        week: "Week 1",
        day: "Sat, Dec 6",
      ...
      },
      {
        ...
        time: "9 AM – 5 PM",
        coverage:
          "Module 7, 8 & 11: Malware Threats, Sniffing & Session Hijacking",
      },
      {
        week: "Week 3",
        day: "Fri, Dec 19",
        time: "9 AM – 5 PM",
        coverage:
          "Module 9, 10 & 12: Social Engineering, DoS/DDoS, IDS/Firewall Evasion",
      },
      {
        week: "Week 3",
        day: "Sat, Dec 20",
      ...
      },
      {
        ...
        time: "9 AM – 5 PM",
        coverage:
          "Practical Lab: Attack–Defense Simulation (Hands-on exercises covering all modules)",
      },
      {
        week: "Week 6",
        day: "Fri, Jan 9",
